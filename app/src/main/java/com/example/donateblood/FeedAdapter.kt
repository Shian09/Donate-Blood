...
class FeedAdapter (val searchedData: UserClass, val requestDesc: String?): Item<GroupieViewHolder>(){
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        viewHolder.itemView.requestDescription.setText("Request for blood: " + requestDesc)
    }
